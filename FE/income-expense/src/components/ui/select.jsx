...
import { SvgDrink, SvgFoodOrange, SvgGift, SvgHome, SvgShopping, SvgTaxi } from "../files"

const Svgs = [<SvgHome/>, <SvgGift/>, <SvgFoodOrange/>, <SvgDrink/>, <SvgTaxi/>, <SvgShopping/>]
...
const SelectItem = React.forwardRef(({ className, children, index, ...props }, ref) => (
